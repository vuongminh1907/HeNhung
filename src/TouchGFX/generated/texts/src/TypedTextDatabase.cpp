...
extern touchgfx::GeneratedFont& getFont_IMPRISHA_TTF_30_4bpp();
extern touchgfx::GeneratedFont& getFont_IMPRISHA_TTF_50_4bpp();

const touchgfx::Font* touchgfx_fonts[] = {
    &(getFont_verdana_20_4bpp()),
    &(getFont_verdana_40_4bpp()),
    &(getFont_verdana_10_4bpp()),
    &(getFont_IMPRISHA_TTF_30_4bpp()),
    &(getFont_IMPRISHA_TTF_50_4bpp())
};
...
void resetFont(touchgfx::FontId fontId)
{
    ...
    case 2:
        ...
        break;
    case 3:
        touchgfx_fonts[3] = &(getFont_IMPRISHA_TTF_30_4bpp());
        break;
    case 4:
        touchgfx_fonts[4] = &(getFont_IMPRISHA_TTF_50_4bpp());
        break;
    }
}
} // namespace TypedTextDatabase
